...
## 🥳 Version (코드 변경시 각 파트 가장 아래에 설명 추가)

### try2(now)

- UI 개선
- 요소들의 크기를 축소시켜서 To-Do-List 부분을 넓히고, 디자인이 더 예뻐보이게 함.
- CSS에 약간의 변화. JS는 변수명, 함수명이 달라진 것 외에는 큰 변화 없음.
...
<img width="426" alt="스크린샷 2022-02-02 오후 8 53 33" src="https://user-images.githubusercontent.com/86224851/152628242-9ce8bacd-0017-4067-8b7c-50c503d510d8.png">
...
> try1에서는 요소를 가운데 정렬하기 위해서 **display: flex** 와 **justify-content: center** 를 활용했다.  
> 그러나 try2에서는 **flex-direction: column** 으로 설정해서, 메인 축의 방향을 바꾼 뒤 **align-items: center** 를 사용해서 가운데 정렬을 해줬다.
